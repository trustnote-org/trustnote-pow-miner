...
int Network_Interface::epoll_loop(pthread_mutex_t *ws_lock, char *payload){
...
void Network_Interface::run(pthread_mutex_t *ws_lock, char *payload){
	epoll_loop(ws_lock, payload);
}
