...
vmovdqa yword [rcx+EH.mids+0x80], ymm0
vmovdqa yword [rcx+EH.mids+0xa0], ymm1
vmovq xmm5, [rdx+0x80]
vpbroadcastq ymm4, xmm5
vmovdqa yword [rcx+EH.mids+0xc0], ymm4
...
vpshufd ymm3, ymm3, 0xb1
	vmovq [rcx+EH.mids+0x08], xmm3	;v12
vpaddq ymm2, ymm2, ymm3
	vmovq [rcx+EH.mids+0x10], xmm2	;v8
vpxor ymm1, ymm1, ymm2
vpshufb ymm1, ymm1, ymm6
	vmovq [rcx+EH.mids+0x18], xmm1	;v4

vpaddq ymm0, ymm0, ymm1
	vmovq [rcx+EH.mids], xmm0	;v0, v3 ready
;add message (nonce, index) to xmm0 here, but we don't have
vpxor ymm3, ymm3, ymm0
vpshufb ymm3, ymm3, ymm7
vextracti128 xmm4, ymm3, 1
	vmovdqa xword [rcx+EH.mids+0x40], xmm4	;v14,15
vpaddq ymm2, ymm2, ymm3
	vpextrq [rcx+EH.mids+0x70], xmm2, 1	;v9
...
vpermq ymm1, ymm1, 0x39
	vmovdqa xword [rcx+EH.mids+0x20], xmm1	;v5,6

vextracti128 xmm4, ymm0, 1
vextracti128 xmm5, ymm1, 1
	vpextrq [rcx+EH.mids+0x60], xmm4, 1	;v3
	vmovq [rcx+EH.mids+0x68], xmm5		;v7

vpsrldq xmm3, xmm3, 8
vpaddq xmm0, xmm0, xmm1
	vpextrq [rcx+EH.mids+0x30], xmm0, 1	;v1
vpaddq xmm4, xmm4, xmm5
	vmovq [rcx+EH.mids+0x78], xmm4		;v2
vpxor xmm3, xmm3, xmm4
vpshufd xmm3, xmm3, 0xb1
	vmovq [rcx+EH.mids+0x38], xmm3		;v13
